...
const getTokensCacheKey = (code: string | undefined | null, language: BundledLanguage) => {
  if (!code) return `${language}:0::`;
...
const createRawTokens = (code: string | undefined | null): TokenizedCode => {
