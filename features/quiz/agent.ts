...
export function createQuizAgentTools(ctx: Pick<AgentToolContext, 'documentIds' | 'rerankEnabled'>) {
  ...
  return {
    ...
    analyze_learning_gaps: tool({
      description:
        "Analyze a learner's weak areas based on their answers, scores, and feedback. Use this when the user wants to understand misconceptions, diagnose weak topics, or decide what to revise next.",
