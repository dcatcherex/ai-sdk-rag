      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {templates.map((t) => (
          ...
          >
            <div
              className={cn(
                "relative overflow-hidden rounded-lg bg-muted p-4  transition-all dark:bg-muted/40 hover:bg-accent",
                selectedId === t.id
                  ? "border-primary ring-2 ring-primary/60 dark:border-primary dark:ring-primary/40"
            ...
            >
              ...
              <div className="relative flex aspect-4/3 items-center justify-center overflow-hidden rounded-sm  dark:bg-zinc-900/70">
            ...
            <div className="px-2 pt-3">
              <p className="truncate text-base font-medium text-zinc-800 dark:text-zinc-100">
                {t.name}
              </p>
