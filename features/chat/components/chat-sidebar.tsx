...
import type { NavItemId } from "./sidebar/sidebar-nav";
...
// Module-level cache â€” survives component remounts on navigation.
...
export const ChatSidebar = ({
  ...
  const sharedProps = {
    ...
    pinnedItemIds,
    hiddenItemIds,
    onToggleNavPin: (itemId: NavItemId) => void togglePinnedItem(itemId),
    onReorderPinned: (orderedItemIds: NavItemId[]) => void reorderPinnedItems(orderedItemIds),
  };
