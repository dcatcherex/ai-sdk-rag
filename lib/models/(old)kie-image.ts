...
export const KIE_IMAGE_MODELS: ModelDefinition[] = [
  ...
  // ─── Nano Banana ────────────────────────────────────────────────────────────
  {
    id: "nano-banana-2",
    name: "Nano Banana 2",
    description: "Experience Google's Gemini 3.1 Flash Image technology featuring 4K generation, lightning-fast speeds, and perfect character consistency for developers.",
    capabilities: ["image"],
    provider: 'kie',
    costPerGeneration: 8,
    isNew: true,
  ...
  },
  {
    ...
    description: "Gemini 3 Pro — flawless text rendering, 4K resolution, up to 8 reference images",
    capabilities: ["image"],
    provider: 'kie',
  ...
  },
  {
    ...
    name: "Nano Banana",
    description: "Gemini 2.5 Flash — fast and cost-efficient text-to-image",
    capabilities: ["image"],
    provider: 'kie',
    costPerGeneration: 4,
    isNew: false,
  ...
  },
  {
    ...
    description: "Gemini 2.5 Flash — edit and transform existing images",
    capabilities: ["image"],
    provider: 'kie',
    costPerGeneration: 4,
    isNew: true,
  ...
  // ─── Seedream 5 Lite ────────────────────────────────────────────────────────
  {
    ...
    description: "ByteDance — 4K generation, precise editing, consistent multi-image output",
    capabilities: ["image"],
    provider: 'kie',
    costPerGeneration: 4,
    isNew: true,
  ...
  // ─── Seedream 4.5 ───────────────────────────────────────────────────────────
  {
    ...
    name: "Seedream 4.5",
    description: "ByteDance — versatile text-to-image with high fidelity",
    capabilities: ["image"],
    provider: 'kie',
  ...
  },
  {
    ...
    description: "ByteDance — precise image editing and transformation",
    capabilities: ["image"],
    provider: 'kie',
    costPerGeneration: 6.5,
    isNew: true,
  ...
  // ─── Qwen ───────────────────────────────────────────────────────────────────
  {
    ...
    description: "Open-source text-to-image, excellent bilingual text rendering",
    capabilities: ["image"],
    provider: 'kie',
    costPerGeneration: 3,
    isNew: true,
