...
export const KIE_VIDEO_MODELS: ModelDefinition[] = [
  ...
  // ─── Grok (xAI) ─────────────────────────────────────────────────────────────
  {
    ...
    name: "Grok Text→Video",
    description: "Fast text-to-video with aspect ratio, mode, and resolution control.",
    capabilities: ["video"],
    provider: 'kie',
    costPerGeneration: 30,
    isNew: true,
    ...
    videoOptions: {
      ...
      quality: { param: 'mode', values: ['normal', 'fun', 'spicy'] },
      resolution: { param: 'resolution', values: ['480p', '720p'] },
      promptRequired: true,
      iconProvider: 'xai',
      badge: 'New',
    },
  },
  {
    ...
    description: "Animate an image with an optional prompt. Supports mode and resolution control.",
    capabilities: ["video"],
    provider: 'kie',
    costPerGeneration: 30,
    isNew: true,
    ...
    videoOptions: {
      apiType: 'standard',
      inputMode: 'image',
      aspectRatios: null,           // aspect_ratio is invalid for single image input
      duration: ['6', '10'],
      durationParam: 'duration',
      quality: { param: 'mode', values: ['normal', 'fun', 'spicy'] },
      resolution: { param: 'resolution', values: ['480p', '720p'] },
