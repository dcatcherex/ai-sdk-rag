...
export default function KnowledgePage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#f2f0fa,_#e8e4f5_55%,_#dddaf0_100%)] dark:bg-[radial-gradient(circle_at_top,_#1a1b2e,_#111827_55%,_#0f172a_100%)]">
      <div className="mx-auto max-w-5xl px-4 py-6">
        ...
        {/* Upload section */}
        <div className="mb-8 rounded-3xl border border-black/5 dark:border-white/10 bg-card/70 dark:bg-zinc-900/80 p-6 shadow-[0_20px_60px_-40px_rgba(15,23,42,0.25)] dark:shadow-[0_20px_60px_-40px_rgba(0,0,0,0.5)] backdrop-blur">
