# 5 Lite Image To Image API Documentation

> Generate content using the 5 Lite Image To Image model

## Overview

This document describes how to use the 5 Lite Image To Image model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `seedream/5-lite-image-to-image` |
...
|----------|-------|-------------|
| **Format** | `seedream/5-lite-image-to-image` | The exact model identifier for this API |
...
- **Max Length**: 2996 characters
- **Default Value**: `"Change the lighting effect to light spots"`
...
- **Multiple Files**: Yes
- **Default Value**: `["https://static.aiquickdraw.com/tools/example/1772015399360_taMCXESx.png"]`
...
```json
{
  ...
  "input": {
    ...
    "image_urls": ["https://static.aiquickdraw.com/tools/example/1772015399360_taMCXESx.png"],
    "aspect_ratio": "1:1",
    "quality": "basic",
    "nsfw_checker": true
  }
...
```json
{
  ...
  "data": {
    ...
    "model": "seedream/5-lite-image-to-image",
    "state": "waiting",
    "param": "{\"model\":\"seedream/5-lite-image-to-image\",\"input\":{\"prompt\":\"Change the lighting effect to light spots\",\"image_urls\":[\"https://static.aiquickdraw.com/tools/example/1772015399360_taMCXESx.png\"],\"aspect_ratio\":\"1:1\",\"quality\":\"basic\",\"nsfw_checker\":true}}",
    "resultJson": "{\"resultUrls\":[\"https://static.aiquickdraw.com/tools/example/1772015413046_CAXZY8rL.png\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
