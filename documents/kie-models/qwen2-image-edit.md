...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `qwen2/image-edit` |
...
|----------|-------|-------------|
| **Format** | `qwen2/image-edit` | The exact model identifier for this API |
...
- **Default Value**: `"Generate a nine-grid image set featuring different poses."`

#### image_url
- **Type**: `array`
- **Required**: Yes
- **Description**: Please provide the URL of the uploaded file,The reference image to guide the edit
- **Max File Size**: 10MB
- **Accepted File Types**: image/jpeg, image/png, image/webp
- **Multiple Files**: Yes
- **Default Value**: `["https://static.aiquickdraw.com/tools/example/1773473208660_6EO8TFjh.webp"]`
...
```json
{
  ...
  "input": {
    "prompt": "Generate a nine-grid image set featuring different poses.",
    "image_url": ["https://static.aiquickdraw.com/tools/example/1773473208660_6EO8TFjh.webp"],
    "image_size": "16:9",
    "output_format": "png",
    "seed": 42
  }
...
```json
{
  ...
  "data": {
    ...
    "model": "qwen2/image-edit",
    "state": "waiting",
    "param": "{\"model\":\"qwen2/image-edit\",\"input\":{\"prompt\":\"Generate a nine-grid image set featuring different poses.\",\"image_url\":[\"https://static.aiquickdraw.com/tools/example/1773473208660_6EO8TFjh.webp\"],\"image_size\":\"16:9\",\"output_format\":\"png\",\"seed\":42}}",
    "resultJson": "{\"resultUrls\":[\"https://static.aiquickdraw.com/tools/example/1773473265297_wM9c2Ul8.webp\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
