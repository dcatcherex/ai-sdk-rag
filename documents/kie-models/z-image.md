...
```json
{
  ...
  "data": {
    ...
    "model": "z-image",
    "state": "waiting",
    "param": "{\"model\":\"z-image\",\"input\":{\"prompt\":\"A hyper-realistic, close-up portrait of a 30-year-old mixed-heritage French-Italian woman drinking coffee from a cup that says “Z-Image × Kie AI.” Natural light. Shot on a Leica M6 with a Kodak Portra 400 film-grain aesthetic.\",\"aspect_ratio\":\"1:1\",\"nsfw_checker\":true}}",
