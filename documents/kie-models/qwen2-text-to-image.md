...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `qwen2/text-to-image` |
...
|----------|-------|-------------|
| **Format** | `qwen2/text-to-image` | The exact model identifier for this API |
...
- **Type**: `string`
- **Required**: Yes
- **Description**: Describe the content of the generated image
...
```json
{
  ...
  "data": {
    ...
    "model": "qwen2/text-to-image",
    "state": "waiting",
    "param": "{\"model\":\"qwen2/text-to-image\",\"input\":{\"prompt\":\"Enter your prompt here...\",\"image_size\":\"16:9\",\"output_format\":\"png\",\"seed\":42}}",
